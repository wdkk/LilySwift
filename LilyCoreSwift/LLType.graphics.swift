...
{
    public var R:LLUInt8 = 0 /// R値 (min:0 ~ max:255)
    public var G:LLUInt8 = 0 /// G値 (min:0 ~ max:255)
    public var B:LLUInt8 = 0 /// B値 (min:0 ~ max:255)
    public var A:LLUInt8 = 0 /// A値 (min:0 ~ max:255)
}
/// NULL無しLLColor8ポインタ型
...
{
    public var R:LLUInt16 = 0 /// R値 (min:0 ~ max:65535)
    public var G:LLUInt16 = 0 /// G値 (min:0 ~ max:65535)
    public var B:LLUInt16 = 0 /// B値 (min:0 ~ max:65535)
    public var A:LLUInt16 = 0 /// A値 (min:0 ~ max:65535)
}
...
{
    public var R:LLInt32 = 0 /// R値 ( min:-2147483648 ~ max:2147483647 )
    public var G:LLInt32 = 0 /// G値 ( min:-2147483648 ~ max:2147483647 )
    public var B:LLInt32 = 0 /// B値 ( min:-2147483648 ~ max:2147483647 )
    public var A:LLInt32 = 0 /// A値 ( min:-2147483648 ~ max:2147483647 )
}
...
{
    public var R:LLFloat = 0.0  /// R値 ( min:0.0 ~ max:1,0 )
    public var G:LLFloat = 0.0  /// G値 ( min:0.0 ~ max:1,0 )
    public var B:LLFloat = 0.0  /// B値 ( min:0.0 ~ max:1,0 )
    public var A:LLFloat = 0.0  /// A値 ( min:0.0 ~ max:1,0 )
}
/// NULL無しLLColorポインタ型
...
{
    public var R:LLDouble = 0.0  /// R値 ( min:0.0 ~ max:1,0 )
    public var G:LLDouble = 0.0  /// G値 ( min:0.0 ~ max:1,0 )
    public var B:LLDouble = 0.0  /// B値 ( min:0.0 ~ max:1,0 )
    public var A:LLDouble = 0.0  /// A値 ( min:0.0 ~ max:1,0 )
}
/// NULL無しLLColorDポインタ型
...
{
    public var B:LLUInt8  /// B値 (min:0 ~ max:255)
    public var G:LLUInt8  /// G値 (min:0 ~ max:255)
    public var R:LLUInt8  /// R値 (min:0 ~ max:255)
    public var A:LLUInt8  /// A値 (min:0 ~ max:255)
}
/// NULL無しLLBGRA8ポインタ型
...
{
    public var H:LLUInt16 = 0 /// 色相値( 0 ~ 360 )
    public var S:LLUInt8 = 0  /// 彩度値( 0 ~ 255 )
    public var V:LLUInt8 = 0  /// 明度値( 0 ~ 255 )
}
...
{
    public var H:LLFloat = 0.0  /// 色相値( 0.0 ~ 360.0 )
    public var S:LLFloat = 0.0  /// 彩度値( 0.0 ~ 1.0 )
    public var V:LLFloat = 0.0  /// 明度値( 0.0 ~ 1.0 )
}
/// NULL無しLLHSVポインタ型
