...
async
{
    ...
    case .hsvf:
        ...
        await LCImageProcRotateNearest(img_conv, img_dst_, degree, resizing)
...
class __LCImageProcRotateNearest<TType, TColor>
...
class __LCImageProcRotateNearestColor<TType, TColor>
