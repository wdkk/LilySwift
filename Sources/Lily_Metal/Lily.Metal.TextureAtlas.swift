    ...
    open class TextureAtlas
    {
        ...
        public func commit() -> Self { 
            ...
            for imgrc in image_rects {
                ...
                let left  = (px.d + 0.334) / all_size.width.d
                let top   = (py.d + 0.334) / all_size.height.d
                let right = ((px + wid).d - 0.334) / all_size.width.d
                let bottom = ((py + hgt).d - 0.334) / all_size.height.d            
