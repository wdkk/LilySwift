...
public extension LBPanelPipeline
{
    ...
    -> LBPanelPipeline 
    {
        ...
        .vertexShader(
            ...
            """,
            shaderName:"LBPanelVertexMaskAtlas_\(label)" )
        )
        .fragmentShader(
            LLMetalShader( 
            code: str_struct +
            ...
            fragment
            float4
            LBPanelFragmentMaskAtlas_\(label)(
            ...
            """,
            shaderName:"LBPanelFragmentMaskAtlas_\(label)" )
        )
