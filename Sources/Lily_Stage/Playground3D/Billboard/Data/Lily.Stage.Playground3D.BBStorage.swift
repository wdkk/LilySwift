...
extension Lily.Stage.Playground3D.Billboard
{
    ...
    open class BBStorage : Hashable
    {
        ...
        static let defaultQuadrangleVertice = LLQuad<Lily.Stage.Playground3D.Billboard.BBVIn>(
        ...
        static let defaultTriangleVertice = LLQuad<Lily.Stage.Playground3D.Billboard.BBVIn>(
